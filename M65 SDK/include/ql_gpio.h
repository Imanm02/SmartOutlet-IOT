...
*               QL_RET_ERR_USED, the GPIO is in use in other place. For example this GPIO has been using as EINT.
*****************************************************************/
...
*               QL_RET_OK, this function succeeds.
*               QL_RET_ERR_PARAM, the input GPIO is invalid. 
*               QL_RET_ERR_NOT_INIT, can't operate,Maybe the GPIO not Init
*****************************************************************/
...
*                   Pin name, one value of Enum_PinName.
* Return:        
*               The level value of the specified GPIO, which is nonnegative integer.
*               QL_RET_ERR_PARAM, the input GPIO is invalid. 
*               QL_RET_ERR_NOT_INIT, can't operate,Maybe the GPIO not Init
*****************************************************************/
...
*                   Pin name, one value of Enum_PinName.
* Return:        
*               The direction of the specified GPIO, which is nonnegative integer..
*               QL_RET_ERR_PARAM, the input GPIO is invalid. 
*               QL_RET_ERR_NOT_INIT, can't operate,Maybe the GPIO not Init
*****************************************************************/
