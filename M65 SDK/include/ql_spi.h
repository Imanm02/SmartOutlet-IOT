...
*               QL_RET_ERR_USED,the pin or channl no. is used already.
*               QL_RET_ERR_FULL, SPI bus is full.
*======================
* Example:
*======================
...
*   Ql_SPI_Init(    1,                  //spi channel select.
                    ...
                    PINNAME_PCM_CLK,    //spi CS pin, user can not change this pin to another pin.
                    1			//for H/W SPI.
                );
...
*   Ql_SPI_Init(    1,                  //spi channel select.
                    ...
                    PINNAME_PCM_CLK,    //Ignore it. User could chose another pin and initialize it, maintain the level by self.
                    0			//for S/W SPI.
                );                
*****************************************************************/
...
*                        the range of SPI speed is from 1Mbps to 28Mbps.
* Return:        
*               QL_RET_OK, this function succeeds.
*               QL_RET_ERR_PARAM, patameter error.
*               QL_RET_ERR_INVALID_PARAM, the input pin is invalid.
...
*   Ql_SPI_Config(  1,      //spi channel select, now only supports 1.
                    ...
                    10,  //10MHZ spi clock speed, the unit is MHz.
                );
*****************************************************************/
...
*               len:
*                   [In] Number of bytes to write,Maximum 2048.
* Return:        
...
*               rdLen:
*                   [In] Number of bytes to read,Maximum 2048.
* Return:        
*               if no error, return the length of the write data.
*
*               QL_RET_ERR_PARAM, patameter error.
...
*               QL_RET_OK, this function succeeds.
*               QL_RET_ERR_CHANNEL_NOT_FOUND, can't found the SPI channel, make sure it is initialized already.
*               QL_RET_ERR_NOT_INIT, can't operate,Maybe not Init to SPI
*****************************************************************/
