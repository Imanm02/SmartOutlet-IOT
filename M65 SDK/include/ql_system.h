...
* Return:        
*               Mutex Id.
*               Attention: The total number of mutex in kernel is 
*               16. If this API returns 0x0F, calling this API 
*               again may cause system assert!
*****************************************************************/
...
/*****************************************************************
* Function:     Ql_OS_SetLastErrorCode 
* 
* Description:
*               Set error code
...
*****************************************************************/
s32 Ql_OS_SetLastErrorCode(s32 errCode);

/*****************************************************************
* Function:     Ql_OS_GetLastErrorCode 
* 
* Description:
...
*****************************************************************/
s32 Ql_OS_GetLastErrorCode(void);
