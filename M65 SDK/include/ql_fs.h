...
/********************************************************************************
*Below are two security interfaces. When users use the following interface to read and write files,
*they save a temporary file backup. Avoid file destroy when read and write abnormal occur.
*
**************/

/******************************************************************************
* Function:     Ql_FS_Safe_Read
*  
* Description:
*               This function safe read data from the beginning of the file. After the read operation has been 
*               completed, the file pointer is adjusted by the number of bytes actually read.
* Parameters:    
*               filename:
*                   [in]The name of the file. The name is limited to 252 characters.
*                       You must use a relative path, such as "RAM:filename.text" in RAM space, "filename.text" in UFS space. 
*
*               readBuffer:
*                   [out] Point to the buffer that receives the data read from the file.
*
...
*               QL_RET_OK, suceess
*               QL_RET_ERR_PARAM, read file failed.
*               QL_RET_ERR_FILEREADFAILED, read file failed or file not exist, if the file not exist,user need to 
*  write file first.
******************************************************************************/
s32 Ql_FS_Safe_Read(u8 *filename, u8 *readBuffer, u32 numberOfBytesToRead, u32 *numberOfBytesRead);


/******************************************************************************
* Function:     Ql_FS_Safe_Write
*  
* Description:
*               This function safe writes data from the beginning of the file.Not supports seek a postion.
*               After the write operation has been completed, the file pointer 
*               is adjusted by the number of bytes actually written. 
*
* Parameters:    
...
*               QL_RET_ERR_FILEWRITEFAILED, write file failed.
******************************************************************************/
s32 Ql_FS_Safe_Write(u8 *filename, u8 *writeBuffer, u32 numberOfBytesToWrite, u32 *numberOfBytesWritten);
