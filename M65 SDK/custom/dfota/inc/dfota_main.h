 ...
 * Description:
 * ------------
 * This file is for upgrading application processing by DFOTA.
 *
 * Author:
 * -------
 * -------
 ...
 * 
 ****************************************************************************/
#ifndef __DFOTA_MAIN_H__
#define __DFOTA_MAIN_H__
#include "ql_type.h"
#include "ql_uart.h"
#include "ql_gpio.h"
...
/*****************************************************************
* Function:     Ql_DFOTA_StartUpgrade
*
* Description:
...
*                            2. If there are no username and password, "@username:password" ("@" must be included) can be omitted. .
*
*                    eg1: ftp://www.jjj.com/filePath/xxx.bin:8021@username:password 
*                    eg2: ftp://www.jjj.com/filePath/xxx.bin@username:password     
*                    eg3: ftp://192.168.10.10/filePath/APP.pack
*                    eg4: http://23.11.67.89/filePath/xxx.pack 
*                    eg5: http://www.quectel.com:8080/filePath/xxx.pack
*                   
*                apnCfg:
...
*                   If it's NULL, a default callback function "Dfota_Upgrade_States" will be adopted.
* Return:
*                0 indicates this function successes.
*               -1 indicates this function failure.
*****************************************************************/
s32 Ql_DFOTA_StartUpgrade(u8* url, ST_GprsConfig* apnCfg, Callback_Upgrade_State callbcak_UpgradeState_Ind);
